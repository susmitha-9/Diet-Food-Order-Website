...
?>
    ...
    <div class="container" style="background-image: linear-gradient(rgba(0,0,0,0.5),rgba(0,0,0,0.5)), url(conn.jpg);
    ...
    <div class="col-md-5" style="margin-top: 1%">
      <div class="form-area">
        ...
        <br style="clear: both">
          <h3 style="margin-bottom: 25px; text-align: center; font-size: 30px;text-shadow: 2px 2px 10px #999999;"> Want to contact?</h3>
