...
<?php
  ...
  ?>
           <ul class="nav navbar-nav navbar-right">
            ...
            <li class="active" ><a href="foodlist.php"> Food </a></li>
...
?>
    ...
    <div class="carousel-inner">
      ...
      <img src="images/farm.jpg" style="width:100%;">
      <div class="carousel-caption">
      </div>
      </div>
       
      <div class="item">
      <img src="images/millet.jpg" style="width:100%;">
      <div class="carousel-caption">

      </div>
      </div>
      <div class="item">
      <img src="images/breakfast.jpg" style="width:100%;">
      <div class="carousel-caption">
      </div>
      </div>  
    </div>
...
<div class="jumbotron">
  <div class="container text-center">
    <h1>WELCOME TO THE CROP STORY</h1>      
  </div>
</div>
...
<input type="submit" name="add" style="margin-top:5px; background-color: #fb9200; border: 1px solid #fb9200;" class="btn btn-success" value="Add to Cart">
</div>
</form>     
</div>
...
else
{
  ...
  <div class="container">
    <div class="jumbotron">
      <center>
         <label style="margin-left: 5px;color: red;"> <h1>Food not available</h1> </label>
        <p>!</p>
      </center>
